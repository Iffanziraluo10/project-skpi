...
<head>
	...
	<link rel="stylesheet" href="mhs/assets/vendor/fontawesome/css/all.min.css">
</head>
<body>
		...
		<div class="container-login100" style="background-image: url('images/bg_skpi.png');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-30 p-b-54">
				<form action="login_act.php" class="login100-form validate-form" method="POST" autocomplete="off">
					...
					<span class="login100-form-title p-b-49 text-white">Login</span>
					<div class="p-t-0 text-white text-center">
						...
						if(isset($_GET['pesan'])){
							...
							<?php }else if($_GET['pesan'] == "berhasil_daftar"){ ?>
								<div class="alert alert-success" role="alert">
									Terimakasih, silahkan menunggu validasi dari admin
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
								</div>
					...
					<a class="text text-left text-white fs-12" href="registrasi.php">Belum memiliki akun ? <i class="fas fa-hand-point-right"></i> Registrasi disini <i class="fas fa-hand-point-left"></i></a>
				</form>
			</div>
		</div>
	</div>
	...
	<script src="mhs/assets/vendor/fontawesome/js/all.min.js"></script>
	<script>
